We are given a python program with the code 
...
We notice that the last line of the program has improper indentation so after we delete the indent and run the program again we get the flag
